        ...
        DecoratedBox(
          decoration: const BoxDecoration(
            image: DecorationImage(
              image: AssetImage('images/Stroopins.jpg'),
              fit: BoxFit.cover,
            ),
          ),
          child: Padding(
            padding: const EdgeInsets.only(bottom: 279),
            child: Align(
        ...
        children: [
          ...
          Positioned(
            ...
            child: Row(
              ...
              children: [
                Text(score.toString(), style: const TextStyle(fontSize: 20, color: Colors.black)),
                const Text(': عوده ', style: TextStyle(fontSize: 20, color: Colors.black)),
              ],
            ),
          ),
          Positioned(
    ...
    return MaterialApp(
      home: Scaffold(
        ...
        body: DecoratedBox(
          decoration: const BoxDecoration(
            image: DecorationImage(
              image: AssetImage('images/Level1connicting.jpg'),
              fit: BoxFit.cover,
            ),
          ),
          child: Stack(
    ...
    return MaterialApp(
      home: Scaffold(
        ...
        body: DecoratedBox(
          decoration: const BoxDecoration(
            image: DecorationImage(
              image: AssetImage('images/ConnectingBackground.jpg'),
              fit: BoxFit.cover,
            ),
          ),
          child: Stack(
    ...
    return MaterialApp(
      home: Scaffold(
        ...
        body: DecoratedBox(
          decoration: const BoxDecoration(
            image: DecorationImage(
              image: AssetImage('images/Level1picsAndword.jpg'),
              fit: BoxFit.cover,
            ),
          ),
          child: Stack(
    ...
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(
          ...
          backgroundColor: Color(0xFFA17135), // تم تغيير لون الخلفية هنا
        ),
        body: Container(
          decoration: BoxDecoration(
            image: DecorationImage(
