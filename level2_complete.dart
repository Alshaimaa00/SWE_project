      ...
      body: Container(
        decoration: BoxDecoration(
          image: DecorationImage(
            image: AssetImage('assets/images/stroop_instrutions(lvl2).jpg'),
            fit: BoxFit.cover,
          ),
        ),
        child: Center(
...
class _ColorGameScreenState extends State<ColorGameScreen> {
  ...
  void playBKG() {
    player.play(AssetSource('sound/lvl2_sound(waves).mp3'));
  }
              ...
              Wrap(
                ...
                children: List<Widget>.generate(
                  words.length,
                      ...
                      ElevatedButton(
                        onPressed: () =>
                            checkAnswer(textColor == colors[index]),
    ...
    return GridView.builder(
      ...
      itemBuilder: (BuildContext context, int index) {
        return GestureDetector(
          ...
          child: Container(
            decoration: BoxDecoration(
              color: pressedStates[index] ? Colors.blueAccent : Colors.transparent,
              border: Border.all(
    ...
    return MaterialApp(
      home: Scaffold(
        ...
        body: Container(
          decoration: BoxDecoration(
            image: DecorationImage(
              image: AssetImage('assets/images/level2_BKG.jpg'),
              fit: BoxFit.cover,
            ),
          ),
          child: MyGame(),
        ...
        /* showDialog(
          ...
          builder: (_) => AlertDialog(
            ...
            content: Column(
              ...
              children: [const
              Text('انتهى الوقت، اضغط التالي للانتقال للخريطة.'),
                const SizedBox(
                  height: 25,
                ),
                Image.asset(
        ...
        Column(
          ...
          children: [
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                Image.asset('assets/images/aramco(lvl2).jpg', width: 170, height: 150), //
                SizedBox(width: 35),
                Image.asset('assets/images/aramco2(lvl2).jpg', width: 170, height: 150), //
              ],
            ),
            SizedBox(height: 20),
            Container(
              ...
              onPressed: () {
                ...
                if (userAnswer == correctAnswer) {
                  ...
                  showDialog(
                    ...
                    builder: (_) => AlertDialog(
                      title: Text('         !ممتاز'),
                      content: Text('إجابتك صحيحة اضغط التالي للانتقال للخريطة'),
                      actions: [
                        TextButton(
                          onPressed: () {
                            resetGame();
