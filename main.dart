      ...
      body: Container(
        decoration: BoxDecoration(
          image: DecorationImage(
            image: AssetImage('assets/stroop_2_instrutions.jpg'),
            fit: BoxFit.cover,
          ),
        ),
        child: Center(
    ...
    centerTitle: true,
      ...
      body: Stack(
        ...
        children: [
          Positioned.fill(
            child: Image.asset(
              'assets/strrop+picword_background2.jpg',
              fit: BoxFit.cover,
            ),
          ),
          Positioned(
  ...
  Widget build(BuildContext context) {
    ...
    centerTitle: true,),
      body: Container(
        decoration: BoxDecoration(
          image: DecorationImage(
            image: AssetImage('assets/obgect_connect_2_instructions.jpg'),
            fit: BoxFit.cover,
          ),
        ),
        child: Center(
       ...
       centerTitle: true,
        ...
        body: DecoratedBox(
          decoration: const BoxDecoration(
            image: DecorationImage(
              image: AssetImage('assets/connect_object_bacground_2.jpg'),
              fit: BoxFit.cover,
            ),
          ),
          child: Stack(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        decoration: BoxDecoration(
          image: DecorationImage(
            image: AssetImage('assets/pics_and_word_2_instructions.jpg'),
            fit: BoxFit.cover,
          ),
        ),
        child: Center(
    ...
    return MaterialApp(
      home: Scaffold(
        ...
        body: Container(
          decoration: BoxDecoration(
            image: DecorationImage(
              image: AssetImage('assets/strrop+picword_background2.jpg'),
              fit: BoxFit.cover,
            ),
          ),
          child: MyGame(),
        ...
        Column(
          ...
          children: [
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                Image.asset('assets/aramco.jpg', width: 124, height: 124), //
                SizedBox(width: 20),
                Image.asset('assets/aramco2.jpg', width: 124, height: 124), //
              ],
            ),
            SizedBox(height: 20),
            Container(
