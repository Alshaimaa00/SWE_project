        ...
        const DecoratedBox(
          decoration: BoxDecoration(
            image: DecorationImage(
              image: AssetImage('assets/images/stroop_instrutions(lvl1).jpg'),
              fit: BoxFit.cover,
            ),
          ),
          child: Padding(
...
class ColorGameScreen extends StatefulWidget {
  ...
  const ColorGameScreen({Key? key, required this.onTimeEnded}) : super(key: key);
        ...
        children: [
          ...
          Positioned(
            ...
            child: Row(
              ...
              children: [
                Text(score.toString(), style: const TextStyle(fontSize: 22, color: Colors.black)),
                const Text(' عودة ', style: TextStyle(fontSize: 22, color: Colors.black)),
              ],
            ),
          ),
          Positioned(
                ...
                children: List<Widget>.generate(
                  words.length,
                    ...
                    style: ElevatedButton.styleFrom(
                        enableFeedback: Color == colors[index]),
                  ),
                ),
              ),
      ...
      home: Scaffold(
        ...
        body: DecoratedBox(
          decoration: const BoxDecoration(
            image: DecorationImage(
              image: AssetImage('assets/images/picsNword_instrucions(lvl1).jpg'),
              fit: BoxFit.cover,
            ),
          ),
          child: Stack(
    ...
    return MaterialApp(
      home: Scaffold(
        ...
        body: const DecoratedBox(
          decoration: BoxDecoration(
            image: DecorationImage(
              image: AssetImage('assets/images/dots_BKG(lvl1).jpg'),
              fit: BoxFit.cover,
            ),
          ),
          child: Stack(
        ...
        Column(
          ...
          children: [
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                Image.asset('assets/images/PnW_d(lvl1).jpg', width: 170, height: 120), // زيادة حجم الصورة هنا
                SizedBox(width: 35),
                Image.asset('assets/images/PnW_p(lvl1).jpg', width: 170, height: 120), // زيادة حجم الصورة هنا
              ],
            ),
            SizedBox(height: 20),
            Container(
              ...
              children: [
                for (String letter in letters)
                  ElevatedButton(
                    ...
                    child: Text(
                      letter,
                      style: TextStyle(color: Colors.white60), // تغيير لون النص إلى الأسود هنا
                    ),
                  ),
                ElevatedButton(
                  onPressed: () {
                  ...
                  style: ElevatedButton.styleFrom(
                    backgroundColor: Colors.white, // تغيير لون الخلفية إلى الأزرق هنا
                  ),
                  child: Text(
                    'مسح',
